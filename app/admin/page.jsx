      ...
      <div>{loading ? <p>Loading participant…</p> : participant ? <>
        ...
        <section id="goals" style={{ ...card, marginTop: 18, scrollMarginTop: 20 }}>
          ...
          <form id="goal-editor" onSubmit={saveGoal} style={{ marginTop: 20, padding: 18, borderRadius: 11, background: C.pale, scrollMarginTop: 20 }}>
            ...
            <div className="goal-fields"><Field label="Category"><span style={{ color: C.muted, fontSize: 14, lineHeight: 1.4, whiteSpace: "normal" }}>Choose an existing category from the suggestions, or type a new category.</span><input list="participant-goal-categories" value={goalDraft.categoryName} onChange={(e) => setGoalDraft({ ...goalDraft, categoryName: e.target.value })} placeholder="Select or type a category" style={input} /></Field><Field label="Goal"><textarea value={goalDraft.goalLabel} onChange={(e) => setGoalDraft({ ...goalDraft, goalLabel: e.target.value })} rows={3} style={{ ...input, resize: "vertical" }} /></Field></div>
